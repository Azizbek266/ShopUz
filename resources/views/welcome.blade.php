...
<head>
    ...
    <!-- Favicon -->
    <link href="assets/assets/img/b.png" rel="icon">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-right">
                ...
                <h5 class="m-0">+998 90 790 89 81</h5>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <a href="/shop.html" class="nav-item nav-link">Maishiy Texnika</a>
                        <a href="" class="nav-item nav-link">Sport Anjomlari</a>
                        <a href="" class="nav-item nav-link">Ofis UY Bog' uchun</a>
                        <a href="" class="nav-item nav-link">Kiyim va poyabzallar</a>
                        <a href="" class="nav-item nav-link">Geymerlar uchun</a>
                        <a href="" class="nav-item nav-link">Smartfon Gadjetlar</a>
                        <a href="" class="nav-item nav-link">Oshxona anjomlari</a>
                        <a href="" class="nav-item nav-link">Avto Jihozlar</a>
                        <a href="" class="nav-item nav-link">Bolalar uchun</a>
                        <a href="" class="nav-item nav-link">Telvizor foto video</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="cart.html" class="nav-item nav-link text-white">Shopping Cart</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="/profil.html" class="btn px-0 ml-3">
    ...
    <!-- Navbar End -->
    <div class=" align-items-center d-block d-lg-none">
        ...
        <ul class="header_navbar_collapse_nav" style="min-height: 54px;">
            <li class="header_navbar_collapse_nav_item">
                <div class="header_navbar_collapse_nav_item_pad">
                    <a class="header_navbar_collapse_nav_item_link active text-dark" href="/index.html"><span
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="assets/img/maishiy texnika.webp" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Maishiy Texnika</h1>
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="assets/img/gamer.webp" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Geymerlar Uchun</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">BUY Now</a>
                                </div>
                            </div>
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="assets/img/sport.webp" style="object-fit: cover;"> 
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Sport Anjomlari</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">BUY Now</a>
                                </div>
                            </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-envelope text-white mr-3"></i>info@example.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-white mr-3"></i>+012 345 67890</p>
            </div>
