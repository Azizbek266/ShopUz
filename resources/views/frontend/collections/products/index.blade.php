            ...
            <div class="col-md-3">
                <div class="product-card">
                    <div class="product-card-img">
                        ...
                        <label for="stock bg-success">In Stock</label>
                        @else
                        <label for="stock bg-danger">Out of Stock</label>
                        @endif
                        @if($productItem->productImages->count()>0)
                        <a href="{{url('/collection/'.$productItem->category->slug.'/'.$productItem->slug)}}">
                        <img src="{{asset($productItem->productImages[0]->image)}}" alt="{{$productItem->name}}" width="100px" height="200px">
                        </a>
                        @endif
                    </div>
